...
Full format description: `docs/MANIFEST-FORMAT.md` in the project repository.

## Installing on a node with opkg

`opkg install nodeplacer_*.ipk` works, but the postinst runs `check_site.lua`
...
configuration, timing). See `docs/DESIGN.md` section 15 in the project
repository.
